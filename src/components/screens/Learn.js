...
import LearnCollapsePlus from "../learn/LearnCollapsePlus";
import LearnCollapse from "../learn/LearnCollapse";
import LearnMenuHeading from "../learn/LearnMenuHeading";
...
How should I take CBD softgel capsules? 
      ...
      "3_1": (
        <div>
          ...
          >
            ...
            the{" "}
            <Link to={`/${this.props.countryCode}/my-account`}>my orders </Link>{" "}
            under the{" "}
            <Link to={`/${this.props.countryCode}/my-account`}>
              My Account{" "}
            </Link>{" "}
            menu.
          </LearnCollapsePlus>
          ...
          <LearnCollapsePlus
            title={
              <span>
                ...
                <Link to={`/${this.props.countryCode}/my-subscription`}>
                  my subscription{" "}
                </Link>
                ?>
              </span>
    ...
    return (
      <div
        className={classNames("container-extend", {
          [className]: className
        })}
      >
        <div
